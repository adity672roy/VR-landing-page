        ...
        <div className="flex flex-col lg:flex-row">
          <div>
            ...
            >
              ...
              libero asperiores reiciendis nemo autem culpa!
            </p>
            <div
              className="flex items-center justify-around space-x-4 max-w-[320px] mx-auto mb-12 lg:space-x-8 lg:max-0 lg:max-w-none lg:justify-start"
              data-aos="fade-down"
              data-aos-delay="700"
            >
