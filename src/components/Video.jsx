    ...
    <div className="bg-[#534686]/30 py-6">
      <div className="container mx-auto">
        <div className="flex flex-col justify-center items-center text-center lg:flex-row lg:justify-between">
          ...
          />
          <div className="bg-videoBg bg-no-repeat bg-cover w-[270px] h-[180px] flex items-center justify-center" data-aos="fade-left"
            data-aos-offset="350">
            <div className="cursor-pointer " onClick={() => setIsOpen(!isOpen)}>
              <BsPlayCircleFill className="text-4xl text-white/80 hover:text-white hove:scale-110 transition" />
            </div>
          </div>
        </div>
      </div>
